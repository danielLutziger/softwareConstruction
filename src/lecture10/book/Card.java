...
{
    private static final Comparator<Card> COMPARATOR = comparing(Card::getSuit).thenComparing(Card::getRank);
    ...
    {
        return aSuit.getColor().equals(Color.BLACK);
    }

    public boolean hasRedSuit()
    {
        return aSuit.getColor().equals(Color.RED);
    }
    ...
    {
        return comparing(card -> card.getRank());
    }
