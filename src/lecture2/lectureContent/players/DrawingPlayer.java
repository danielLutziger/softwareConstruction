package lecture2.lectureContent.players;


import lecture2.lectureContent.model.Drawing;
import lecture2.lectureContent.model.Shape;
import lecture2.lectureContent.ui.DrawingEditor;
...
public class DrawingPlayer implements ActionListener {
    ...
    private List<java.awt.Shape> shapesInColumn;
    ...
    private void selectAndPlayShapes() {
        ...
        for (java.awt.Shape shape : shapesInColumn) {
